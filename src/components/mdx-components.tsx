...
const components = {
  ...
  code: (props: ComponentProps<"code">) => (
    <code
      className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 font-mono text-sm"
      {...props}
    />
  ),
  pre: (props: ComponentProps<"pre">) => (
    <pre
      className="mt-4 p-4 overflow-auto bg-slate-100 dark:bg-slate-800 rounded"
      {...props}
    />
  ),
};
