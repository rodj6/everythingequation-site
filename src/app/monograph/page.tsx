...
import MonographArticle from "@/components/monograph-article";
...
export default async function MonographPage() {
  ...
  const sections: Record<
    string,
    { problems: typeof problems; papers: typeof papers }
  > = {};
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-12 py-16">
      <h2 className="text-3xl font-bold">Monograph</h2>

      {/* NEW: Monograph article content (MDX) */}
      <MonographArticle />
