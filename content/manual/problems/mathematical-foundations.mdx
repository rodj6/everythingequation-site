...
13. [Result Domain and Function](#result-domain-and-function)
...
<table>
  <thead>
    <tr>
      <th>Phenomenon</th>
      <th>Operator diagnosis</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Presentation dependence</td>
      <td>$\partial_{\mathsf{M}}$-failure</td>
    </tr>
    <tr>
      <td>Independence / axiom sensitivity</td>
      <td>$\Delta_{\mathsf{M}}$-failure</td>
    </tr>
    <tr>
      <td>Non-canonical / limit-unstable constructions</td>
      <td>$\Omega_{\mathsf{M}}$-failure</td>
    </tr>
    <tr>
      <td>Canonical reappearance across domains</td>
      <td>$\Omega_{\mathsf{M}}$-closure</td>
    </tr>
    <tr>
      <td>Robustness under foundational reformulation</td>
      <td>High $\partial_{\mathsf{M}}$ and $\Delta_{\mathsf{M}}$ invariance</td>
    </tr>
    <tr>
      <td>Mathematics feeling "discovered"</td>
      <td>Fixed points are forced by the recursion, not chosen</td>
    </tr>
  </tbody>
</table>
...
**Structural classifier.** The admissibility recursion operates upstream of theorem proving: it classifies stable structures, non-lawful statements, and conjectures that occupy an inevitable closure position.

**Foundation-relative criterion.** ZFC, type theory, category theory, and proof theory supply formal environments. The framework provides a criterion for when results in those environments reflect stable mathematical content rather than presentation artifacts or fragile scaffolding.

**Closure-stable existence.** "Existence" means fixed-point admissibility. Ontological talk about numbers or sets functions as shorthand for invariants of admissible structures.

**Computability remains a separate question.** Fixed points exist by Knaster–Tarski, while identifying specific fixed points or deciding admissibility for particular structures may be undecidable. Admissibility determines the stable class; solver classes determine what is reachable.

**Discriminating predictions.** The framework predicts which statements are presentation-dependent ($\partial_{\mathsf{M}}$-failure), which are fragile under perturbation ($\Delta_{\mathsf{M}}$-failure), and which constructions reappear canonically ($\Omega_{\mathsf{M}}$-closure). These predictions can be tested against the structural record of mathematical practice: what persists across reformulations, collapses under weakening, or reappears as canonical completion.
