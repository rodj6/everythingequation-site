...
**What it does:** $\partial_{\mathsf{M}}$ deletes presentation artifacts. A structure that changes under admissible re-presentation fails $\partial_{\mathsf{M}}$ and is not law-level. This is not a judgment — it is a structural diagnosis.
