...
The $\tanh(\beta\xi/2)$ factor is the spectral fingerprint of the Fermi–Dirac/Bose–Einstein statistics familiar from quantum thermal physics. Its appearance here is not assumed from thermodynamics, it's derived from the boundary scattering data of $Q$.
