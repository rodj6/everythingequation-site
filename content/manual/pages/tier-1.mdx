...
3. **Global uniqueness** → $y^* = (y_1^*, \ldots, y_{N_{\mathrm{mass}}}^*)$ (unique on carrier)
4. **E9\*\* normalization bridge** → $\alpha^{-1} = 137$ (zero free parameters)
5. **Therefore:** all masses and couplings are carrier-conditioned structural outputs
...
**Status:** March 2026
**Supporting papers:** The Coupled Dirac–Λ System (Unified), Papers 1–5 (Generation Forcing, Boundary Operator, Mass Prediction, Structural Closure, Geometric Rigidity), The Resolution of 1/137, The Tier-0 Framework - see the papers section for full technical documents.
