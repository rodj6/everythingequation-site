...
Paper VI proves a sharp equivalence: no failure channels at a maximal time (\Longleftrightarrow) eventual strict margin (\Longleftrightarrow) deterministic tail contraction (\Longleftrightarrow) no blowup within the admissible class. In particular, for Navier–Stokes it yields a clean necessity statement:
